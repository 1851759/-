...
#include"cocos2d.h"
USING_NS_CC;
int ret, ID = 1, n = 0, IfStart = 0, IfAI = 0, IfEquipUpdate = 0, P1Exp = 0, P2Exp = 0, P1Blood = 200, P2Blood = 200;         //IfStart判断是否开始，IfAI判断是否是人机对战
...
Client::Client()
{
	...
	CreateThread(NULL, 0, &ClientThread, &ClientSock, 0, NULL);  //再建立子线程
}
