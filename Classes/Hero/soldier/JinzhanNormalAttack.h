#ifndef __JINZHANNORMALATTACK__
#define __JINZHANNORMALATTACK__
...
class JinzhanNormalAttack : public BasicSkill
{
...
public:
	...
	//触发平A
	static JinzhanNormalAttack* createTheAttack(Hero* hero);
	//重载take函数
	void takeJinzhanNormalAttack(cocos2d::Vec2 startPoint, cocos2d::Vec2 targetPoint);
